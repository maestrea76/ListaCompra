...
export const STORES_SEED: Store[] = [
  ...
  { id: 'alcampo',       name: 'Alcampo',          typeId: 'supermercado',     icon: { kind: 'emoji', value: '🦜' }, brand: { bg: '#E94E1B', fg: '#FFFFFF' } },
  ...
  { id: 'lukas',         name: 'Lukas',            typeId: 'supermercado',     icon: { kind: 'emoji', value: '🛍️' }, brand: { bg: '#003366', fg: '#FFD200' } },
  // --- Otros ---
  { id: 'farmacia',      name: 'Farmacia',         typeId: 'farmacia',         icon: { kind: 'emoji', value: '💊' }, brand: { bg: '#0A7E3A', fg: '#FFFFFF' } },
